  ...
  const handleSubmit = useCallback(async (data: IResetPasswordFormData) => {
    try {
      ...
      const schema = Yup.object().shape({
        ...
        password_confirmation: Yup.string().oneOf([Yup.ref('password'), null], 'As senhas não coincidem.')
      });
      ...
      <Content>
        <AnimationContainer>
          ...
          <Form ref={formRef} onSubmit={handleSubmit}>
            ...
            <Input icon={FiLock} name="password_confirmation" placeholder="Confirmação da senha" type="password" />
